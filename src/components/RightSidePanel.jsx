...
const RightSidePanel = ({ isOpen, onClose, selectedPoint }) => {
  return (
    <motion.div
      ...
      className="fixed right-0 top-0 h-full w-80 bg-black/70 backdrop-blur-lg text-white p-4 z-30"
    >
      ...
      <div className="mt-4">
        ...
        <p>Based on current data, there's a 65% chance of increased Mastomys activity in this area over the next month.</p>
      </div>
