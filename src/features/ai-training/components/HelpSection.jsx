    ...
    >
      <div className="bg-gray-800 p-6 rounded-lg max-w-md w-full">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-white">Help & Quick Start Guide</h2>
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <p className="mt-4">Data Source: <a href="https://terabox.com/s/1XqnU4Y9S2p_WPFu1YeIe8A" className="text-blue-400 hover:text-blue-300 underline" target="_blank" rel="noopener noreferrer">Access Database</a></p>
