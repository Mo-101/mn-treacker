  ...
  return (
    <div className="absolute top-0 left-0 right-0 bg-black bg-opacity-50 p-2 z-20 flex justify-between items-center">
      <div className="flex items-center space-x-2">
        <img src="/placeholder.svg" alt="Logo" className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10" />
        ...
        <div className="flex space-x-1 sm:space-x-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" onClick={onLayerToggle} className="hover:bg-yellow-400 hover:text-black transition-colors p-1 sm:p-2">
                <AnimatedIcon>
                  <Layers className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-yellow-400" />
                </AnimatedIcon>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" className="hover:bg-yellow-400 hover:text-black transition-colors p-1 sm:p-2">
                <AnimatedIcon>
                  <Clock className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-yellow-400" />
                </AnimatedIcon>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" onClick={onAITrainingToggle} className="hover:bg-yellow-400 hover:text-black transition-colors p-1 sm:p-2">
                <AnimatedIcon>
                  <Brain className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-yellow-400" />
                </AnimatedIcon>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" onClick={onPredictionToggle} className="hover:bg-yellow-400 hover:text-black transition-colors p-1 sm:p-2">
                <AnimatedIcon>
                  <ChartBar className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-yellow-400" />
                </AnimatedIcon>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" className="hover:bg-yellow-400 hover:text-black transition-colors p-1 sm:p-2">
                <AnimatedIcon>
                  <Settings className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-yellow-400" />
                </AnimatedIcon>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
